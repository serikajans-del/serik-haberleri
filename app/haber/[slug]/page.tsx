          ...
          <article className="lg:col-span-3">
            <div className="rounded-sm overflow-hidden" style={{ backgroundColor: "#ffffff", border: "1px solid #e0e0e0" }}>
              ...
              <div className="p-4 md:p-7">
                ...
                {/* ── Meta bilgi satırı ── */}
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 py-2.5 mb-1 text-xs" style={{ color: "#888", borderTop: "1px solid #f0f0f0" }}>
                  {/* Yayınlanma */}
                  ...
                  <span className="flex items-center gap-1.5">
                    ...
                    <span style={{ color: "#555" }}>{news.author}</span>
                  </span>
                  {/* Okuma süresi */}
                  {(() => {
                    ...
                    return (
                      <span className="flex items-center gap-1.5">
                        ...
                        <span style={{ color: "#555" }}>{mins} dk okuma</span>
                      </span>
                    );
                  })()}
                  {/* Görüntülenme */}
                  <span className="flex items-center gap-1.5">
                    ...
                    <span style={{ color: "#555" }}>{(news.views ?? 0) > 0 ? `${news.views} görüntülenme` : "Yeni"}</span>
                  </span>
                  {/* Kategori */}
                  <Link href={`/kategori/${news.categorySlug}`} className="ml-auto">
                    <span className="text-white text-xs font-bold px-2.5 py-1 rounded-sm uppercase tracking-wide" style={{ backgroundColor: "#d90000", fontSize: "10px" }}>
                      {news.category}
                    </span>
                  </Link>
                </div>
                ...
                {/* ── Paylaşım çubuğu ── */}
                <div
                  className="flex items-center justify-between gap-2 px-3 py-2.5 mb-6 rounded"
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    {[
                      ...
                      { label: "LinkedIn",  color: "#0077b5", href: `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(SITE_URL + "/haber/" + news.slug)}`,                                        icon: "M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z" },
                    ].map((s) => (
                      <a
                        key={s.label}
                        href={s.href}
                        ...
                        title={s.label}
                        className="w-8 h-8 flex items-center justify-center rounded text-white transition-opacity hover:opacity-80"
